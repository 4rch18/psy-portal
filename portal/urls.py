...
urlpatterns = (
    ...
    url(r'^home/(?P<userID_from_url>[0-9]+)/$', views.home, name='home'),
    ...
    url(r'^feedback/(?P<clientID>[0-9]+)/$', views.feedback, name='feedback'),
    url(r'^addFB/(?P<clientID>[0-9]+)/$', views.addFB, name='addFB'),
    url(r'^about/(?P<userID>[0-9]+)/$', views.about, name='about'),
